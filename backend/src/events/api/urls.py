...
from .views  import EventListView, EventDetailView,EventListDateView,UserEventCreate,TicketEventListView,TicketRelaListView,EventVideoDetailView#,TicketListView
